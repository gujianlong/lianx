...
public class NetUtils {
        ...
        OkHttpClient okHttpClient = new OkHttpClient.Builder()
                ...
                .addInterceptor(new Interceptor() {
                    ...
                    public Response intercept(Chain chain) throws IOException {
                        SharedPreferences gjl = MyApp.mContent.getSharedPreferences("gjl", Context.MODE_PRIVATE);
    ...
    public void getInfo(String url, Map<String, Object> map, final Class cls, final NetCallBack netCallBack) {
