...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.Holder> {
    ...
    private final List<UserBean.ResultBean.RxxpBean.CommodityListBean> list;
    private final Context context;

    public MyAdapter(List<UserBean.ResultBean.RxxpBean.CommodityListBean> list, Context context) {
