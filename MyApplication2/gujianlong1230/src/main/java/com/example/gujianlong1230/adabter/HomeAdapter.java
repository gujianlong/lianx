...
public class HomeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final List<UserBean.ResultBean.MlssBean> mMlssList;
    private final List<UserBean.ResultBean.PzshBean> mPzshList;
    private final List<UserBean.ResultBean.RxxpBean> mRxxpList;
    private final int one = 1;
    private final int two = 2;
    private final int three = 3;

    public HomeAdapter(Context context, List<UserBean.ResultBean.MlssBean> mMlssList, List<UserBean.ResultBean.PzshBean> mPzshList, List<UserBean.ResultBean.RxxpBean> mRxxpList) {
    ...
    class OneAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        private List<UserBean.ResultBean.RxxpBean.CommodityListBean> list;
        private Context context;

        public OneAdapter(List<UserBean.ResultBean.RxxpBean.CommodityListBean> list, Context context) {
            this.list = list;
            this.context = context;
        }
    ...
    class TwoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public TwoAdapter(List<UserBean.ResultBean.MlssBean.CommodityListBeanXX> list, Context context) {
            this.list = list;
            this.context = context;
        }
    ...
    class ThreeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public ThreeAdapter(List<UserBean.ResultBean.PzshBean.CommodityListBeanX> list, Context context) {
            this.list = list;
            this.context = context;
        }
