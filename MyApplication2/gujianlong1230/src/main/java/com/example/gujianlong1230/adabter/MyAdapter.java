...
public class MyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyAdapter(Context context, List<UserBean.ResultBean.MlssBean> mMlssList, List<UserBean.ResultBean.PzshBean> mPzshList, List<UserBean.ResultBean.RxxpBean> mRxxpList) {
